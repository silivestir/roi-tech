...
const createPost = async(req, res) => {
    try {
        ...
        console.log("hello my name  is  silivestir  and  the code  is working now")
...
const getPostById = async(req, res) => {
    try {
        ...
        const post = await UserPost.findOne({
            ...
            attributes: ['id',
                'createdAt',
                'content', 'posttitle', [sequelize.literal('(SELECT COUNT(*) FROM "Reports" WHERE "postId" = "UserPost"."id")'), 'reportCount'],
